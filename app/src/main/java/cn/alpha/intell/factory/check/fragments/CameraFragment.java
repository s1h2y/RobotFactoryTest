...
import cn.alpha.intell.factory.check.activitys.CameraResultActivity;
import cn.alpha.intell.factory.check.activitys.CaptureActivity;
...
public class CameraFragment extends Fragment {
    ...
    private void checkResult() {
        boolean checked = Constant.FAILED.equals(Result.get(Constant.CAMERA_SHOT)) ? true : false;
