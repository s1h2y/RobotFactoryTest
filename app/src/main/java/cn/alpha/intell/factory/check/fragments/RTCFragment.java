 ...
 * {@link RTCFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link RTCFragment#newInstance} factory method to
...
public class RTCFragment extends Fragment {
     ...
     * @return A new instance of fragment RTCFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static RTCFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_rtc, container, false);
        initView(root);
        return root;
    }
    ...
    private void initView(View root) {
        ...
        mCheck.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    Result.failed(Constant.RTC);
                } else {
                    Result.passed(Constant.RTC);
                }
            }
        });
        checkResult();
